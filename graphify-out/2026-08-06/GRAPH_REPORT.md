# Graph Report - RiseCare-Health-Kiosk  (2026-08-06)

## Corpus Check
- 142 files · ~529,865 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1091 nodes · 1549 edges · 114 communities (64 shown, 50 thin omitted)
...
## Communities (114 total, 50 thin omitted)
...
Cohesion: 0.06
Nodes (49): app, port, connectMQTT(), disconnectMQTT(), isConnected(), messageHandlers, publish(), subscribe() (+41 more)
...
### Community 3 - "cn"
Cohesion: 0.10
Nodes (34): Kbd(), KbdGroup(), SheetHeader(), Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter() (+26 more)
...
Cohesion: 0.07
Nodes (16): Avatar, AvatarFallback, AvatarImage, HoverCardContent, PopoverContent, Progress, RadioGroup, RadioGroupItem (+8 more)
...
Cohesion: 0.10
Nodes (19): TermsAgreementDialogProps, Checkbox, Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList (+11 more)
...
Cohesion: 0.23
Nodes (9): connect(), is_connected(), on_connect(), on_disconnect(), on_message(), publish(), wait_for_connection(), main() (+1 more)
...
### Community 78 - "accordion.tsx"
Cohesion: 0.50
Nodes (3): AccordionContent, AccordionItem, AccordionTrigger

## Knowledge Gaps
- **478 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `__filename`, `__dirname`, `allowlist` (+473 more)
...
- **Why does `cn()` connect `cn` to `Dashboard.tsx`, `utils.ts`, `use-toast.ts`, `field.tsx`, `menubar.tsx`, `pagination.tsx`, `form.tsx`, `command.tsx`, `input-group.tsx`, `item.tsx`, `chart.tsx`, `context-menu.tsx`, `dropdown-menu.tsx`, `table.tsx`, `breadcrumb.tsx`, `drawer.tsx`, `empty.tsx`, `navigation-menu.tsx`, `select.tsx`, `sheet.tsx`, `card.tsx`, `toggle-group.tsx`, `alert.tsx`, `input-otp.tsx`, `badge.tsx`, `carousel.tsx`, `accordion.tsx`?**
