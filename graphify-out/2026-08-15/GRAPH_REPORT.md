...
## Corpus Check
- 157 files · ~543,017 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1183 nodes · 1783 edges · 122 communities (69 shown, 53 thin omitted)
...
Cohesion: 0.13
Nodes (15): dependencies, bcryptjs, body-parser, cookie-parser, cors, express, mqtt, @workspace/db (+7 more)
...
Cohesion: 0.05
Nodes (66): KeypadDialog(), KeypadDialogProps, KioskHeader(), KioskHeaderProps, LoginDialogProps, SettingsAccount, AccountsSettings(), AccountsSettingsProps (+58 more)
...
Cohesion: 0.07
Nodes (20): AccordionContent, AccordionItem, AccordionTrigger, Alert, AlertDescription, AlertTitle, alertVariants, Badge() (+12 more)
...
Cohesion: 0.22
Nodes (7): requireAuth(), router, router, router, router, router, router
...
Cohesion: 0.08
Nodes (28): queryClient, ACTIVITY_EVENTS, IdleTimeout(), Toast, ToastAction, ToastActionElement, ToastClose, ToastDescription (+20 more)
...
## Knowledge Gaps
- **488 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `__filename`, `__dirname`, `allowlist` (+483 more)
...
- **Why does `cn()` connect `cn` to `Dashboard.tsx`, `SettingsDialog.tsx`, `field.tsx`, `menubar.tsx`, `pagination.tsx`, `form.tsx`, `command.tsx`, `input-group.tsx`, `item.tsx`, `context-menu.tsx`, `dropdown-menu.tsx`, `chart.tsx`, `table.tsx`, `utils.ts`, `drawer.tsx`, `empty.tsx`, `select.tsx`, `breadcrumb.tsx`, `carousel.tsx`, `toggle-group.tsx`, `sheet.tsx`, `navigation-menu.tsx`, `App.tsx`, `card.tsx`, `input-otp.tsx`, `avatar.tsx`?**
...
- **Why does `AccountsSettings()` connect `SettingsDialog.tsx` to `ai.ts`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
