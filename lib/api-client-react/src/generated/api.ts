...
export const saveVitals = async (
  id: number,
  saveVitalsRequest: SaveVitalsRequest,
  options?: RequestInit,
  ...
  return customFetch<VitalReading>(getSaveVitalsUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(saveVitalsRequest),
  });
};

export const getSaveVitalsMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type SaveVitalsMutationResult = NonNullable<
  Awaited<ReturnType<typeof saveVitals>>
>;
